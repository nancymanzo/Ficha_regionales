...
ggplot(asi_jal) +
  ...
  theme_minimal()+
  labs(title = "Gráfica 2. Carpetas de investigación por el delito de abuso sexual infantil, de enero 2015 a septiembre 2022",
       caption = "Elaborado con datos de Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública",
       x="", y="", color="", fill="") +
  theme_minimal() + 
  theme(text=element_text(size=11),
...
ggplot(vio_jal) +
  ...
  theme_minimal()+
  labs(title = "Gráfica 5. Carpetas de investigación por el delito de violación, de enero 2015 a septiembre 2022",
       caption = "Elaborado con datos de Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública",
       x="", y="", color="", fill="") +
  theme_minimal() + 
  theme(text=element_text(size=11),
...
ggplot(vf_jal) +
  ...
  scale_y_continuous(labels = scales::comma) +
  theme_minimal()+
  labs(title = "Gráfica 8. Carpetas de investigación por el delito de violencia familiar, de enero 2015 a septiembre 2022",
       caption = "Elaborado con datos de Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública",
       x="", y="", color="", fill="") +
  theme_minimal() + 
  theme(text=element_text(size=11),
...
ggplot(femi_jal) +
  ...
  geom_point(size = 1,colour = "#7030A0")+
  theme_minimal()+
  labs(title = "Gráfica 11. Carpetas de investigación por el delito de feminicidio, de enero 2015 a septiembre 2022",
       caption = "Elaborado con datos de Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública",
       x="", y="", color="", fill="") +
  theme_minimal() + 
  theme(text=element_text(size=11),
